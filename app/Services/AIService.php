...
class AIService
{
    ...
    public function generateTest($subject, $topic, $difficult_level, $num_questions)
    {
        ...
        'question' (текст вопроса), 'options': ['A', 'B', 'C', 'D'], 
        'correct' 
        (
           A) первый вариант
           B) второй вариант
        ...
        'explanation' (объяснение правильного ответа или решение задачи с использованием формул или общепринятых правил, Если тема теста связана с английским языком, предоставь объяснение на русском языке).";
